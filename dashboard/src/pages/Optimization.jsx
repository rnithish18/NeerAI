  ...
  return (
    <div className="page animate-fade-in">
      <div className="section-header" style={{ marginBottom: '2rem' }}>
        ...
        <p style={{ color: 'var(--text-muted)' }}>Actionable insights to reduce AI environmental footprint</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6" style={{ marginBottom: '1.5rem' }}>
        ...
        <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', padding: '2rem' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
            Simulated savings if all recommended optimizations are applied across the institution.
          </p>
        </div>
      </div>
      
      <h3 style={{ marginBottom: '1rem', marginTop: '2rem' }}>Optimization Tips</h3>
